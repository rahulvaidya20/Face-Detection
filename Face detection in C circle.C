...
int main( int argc, char** argv )
{
    ...
    if( !cascade )
    {
        printf( stderr, "ERROR: Could not load classifier cascade\n" );
        return -1;
    }
...
void detect_and_draw( IplImage* img )
{
    ...
    if( cascade )
    {
        ...
        CvSeq* faces = cvHaarDetectObjects( small_img, cascade, storage,1.1, 2, 0|CV_HAAR_SCALE_IMAGE,cvSize(20, 20),cvSize(200,200) );
